...
class WithdrawTransactions extends StatelessWidget {
  List walletList = [];
  bool saveStatus;

  WithdrawTransactions(this.walletList, this.saveStatus);
          ...
          return Container(
            ...
            child: ListTile(
              title: text("Withdrawal Request",
                  // getString(walletList[index].type),
                  fontSize: 10.0.sp),
              subtitle: text(
                // getDate(
                  walletList[index]['date_created'].toString(),
              ...
              trailing: SizedBox(
                ...
                child: Row(
                  children: [
                    ...
                    Text('₹' + walletList[index]['amount_requested'].toString()),
                  ],
                ),
              ),
              leading: Container(
